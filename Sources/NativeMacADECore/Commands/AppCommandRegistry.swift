...
public enum AppCommandRegistry {
    ...
    public static let defaultKeybindings: [AppCommandID: KeybindingOverride] = [
        ...
        .newAgentTabWithProfile: KeybindingOverride(commandID: .newAgentTabWithProfile, keyEquivalent: "p", modifiers: [.command, .shift]),
        .closeSelectedTab: KeybindingOverride(commandID: .closeSelectedTab, keyEquivalent: "w"),
        .renameSelectedSession: KeybindingOverride(commandID: .renameSelectedSession, keyEquivalent: "r"),
        .renameSelectedTab: KeybindingOverride(commandID: .renameSelectedTab, keyEquivalent: "r", modifiers: [.command, .shift]),
        .deleteSelectedSession: KeybindingOverride(commandID: .deleteSelectedSession, keyEquivalent: "w", modifiers: [.command, .shift]),
